...
import { LogOut, Calendar, Clock, User, Mail, Phone, MessageSquare, Check, X, Trash2 } from 'lucide-react'
...
export default function AdminDashboard({ reservations: initialReservations }: Props) {
