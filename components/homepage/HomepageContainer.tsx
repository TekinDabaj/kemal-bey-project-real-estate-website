...
export default function HomepageContainer({ heroSlides }: Props) {
  ...
  const isVisible = (n: number) =>
    activeSlide === n || leavingSlide === n || fadingOutSlide === n;
  ...
  return (
    <>
      ...
      <Slide1
        ...
        leaving={leavingSlide === 1}
        fadingOut={fadingOutSlide === 1}
        visible={isVisible(1)}
        onUpClick={goUp}
        onDownClick={goDown}
      />
      <Slide2
        ...
        leaving={leavingSlide === 2}
        fadingOut={fadingOutSlide === 2}
        visible={isVisible(2)}
        onUpClick={goUp}
        onDownClick={goDown}
      />
      <Slide3
        ...
        leaving={leavingSlide === 3}
        fadingOut={fadingOutSlide === 3}
        visible={isVisible(3)}
        onUpClick={goUp}
        onDownClick={goDown}
      />
      <Slide4
        ...
        leaving={leavingSlide === 4}
        fadingOut={fadingOutSlide === 4}
        visible={isVisible(4)}
        onUpClick={goUp}
        onDownClick={goDown}
      />
      <Slide5
        ...
        leaving={leavingSlide === 5}
        fadingOut={fadingOutSlide === 5}
        visible={isVisible(5)}
        onUpClick={goUp}
      />
    </>
